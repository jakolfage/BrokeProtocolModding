...
namespace AssetBundleBrowser.AssetBundleModel
{
    internal sealed class AssetTreeItem : TreeViewItem
    {
        ...
        internal AssetTreeItem(AssetInfo a) : base(a != null ? a.FullAssetName.GetHashCode() : UnityEngine.Random.Range(int.MinValue, int.MaxValue), 0, a != null ? a.DisplayName : "failed")
        {
            Asset = a;
            if (a != null)
