...
namespace AssetBundleBrowser.AssetBundleModel
{
    ...
    internal class BundleNameData
    {
        ...
        internal string Variant
        {
            ...
            set
            {
                ...
                FullNativeName += String.IsNullOrEmpty(m_VariantName) ? "" : "." + m_VariantName;
            }
        }
    ...
    internal abstract class BundleInfo
    {
        ...
        internal List<MessageSystem.Message> Messages => m_BundleMessages.GetMessages();

        internal bool HasMessages => m_BundleMessages.HasMessages();
    ...
    internal class BundleDataInfo : BundleInfo
    {
        ...
        internal string TotalSize => (m_TotalSize == 0) ? "--" : EditorUtility.FormatBytes(m_TotalSize);
        ...
        internal List<BundleDependencyInfo> BundleDependencies => m_BundleDependencies;
        ...
        internal bool IsEmpty => m_ConcreteAssets.Count == 0;
